...
const FORMATOS = [
  ...
  { value: 'feed',    label: 'Feed',     diasSemana: [3],    cor: '#0ea5e9' }, // qua
  { value: 'reels',   label: 'Reels',    diasSemana: [1],    cor: '#f97316', quinzenal: true }, // seg
  { value: 'email',   label: 'E-mail',   diasSemana: [1],    cor: '#10b981' }, // seg
]
...
function ModalEditora({ editora, onSave, onClose }) {
  const [form, setForm] = useState({ nome: editora?.nome || '', instagram: editora?.instagram || '' })
