...
function Celula({ children, width = 120 }) {
  return (
    <td style={{ padding:'7px 10px', borderRight:'1px solid var(--border)', borderBottom:'1px solid var(--border)', fontSize:12, color:'var(--text)', maxWidth:width, overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap' }}
        ...
        <table style={{ width:'100%', borderCollapse:'collapse', fontSize:12 }}>
          ...
          <tbody>
            {lista.length === 0 ? (
              ...
              <tr key={e.id}
                style={{ background: i % 2 === 0 ? 'var(--surface)' : 'var(--surface-2)', transition:'background 0.1s' }}
